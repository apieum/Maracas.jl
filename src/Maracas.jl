...
set_test_style(color::Symbol, bold::Bool=true) = set_text_style(:test, color, bold ? :bold : :normal)
set_title_style(color::Symbol, bold::Bool=true) = set_text_style(:title, color, bold ? :bold : :normal)
set_spec_style(color::Symbol, bold::Bool=true) = set_text_style(:spec, color, bold ? :bold : :normal)
set_error_color(color::Symbol) = (MARACAS_SETTING[:error] = color)
set_warn_color(color::Symbol) = (MARACAS_SETTING[:warn] = color)
set_pass_color(color::Symbol) = (MARACAS_SETTING[:pass] = color)
set_info_color(color::Symbol) = (MARACAS_SETTING[:info] = color)
